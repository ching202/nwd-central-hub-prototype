        ...
        <header className="bg-white border-b" style={{ borderColor: 'var(--nwd-border)' }}>
          <div className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-3">
            ...
            <div className="flex items-center flex-1 min-w-0">
              ...
              <span className="text-gray-400 mx-2 select-none">/</span>
              <Link href="/login/proposals" className="text-sm text-gray-500 font-medium hover:text-gray-700 transition-colors">
                My Submissions
              </Link>
              <span className="text-gray-400 mx-2 select-none">/</span>
              <span className="text-sm font-medium" style={{ color: 'var(--nwd-teal)' }}>New Proposal</span>
            </div>
            <Link href="/login/proposals" className="text-sm text-gray-400 hover:text-gray-600 transition-colors flex items-center gap-1">
